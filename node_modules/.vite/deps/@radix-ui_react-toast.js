...
var ToastProvider = __name3((props) => {
  const {
    __scopeToast,
    label = "Notification",
    duration = 5e3,
...
var ToastViewport = React4.forwardRef(
  __name3(function ToastViewport2(props, forwardedRef) {
    const {
      __scopeToast,
    ...
    React4.useEffect(() => {
      ...
      if (hasToasts && wrapper && viewport) {
        ...
        const handleFocusOutResume = __name3((event) => {
          const isFocusMovingOutside = !wrapper.contains(event.relatedTarget);
          if (isFocusMovingOutside) handleResume();
        }, "handleFocusOutResume");
        const handlePointerLeaveResume = __name3(() => {
...
var FocusProxy = React4.forwardRef(
  ...
  __name3(function ToastFocusProxy(props, forwardedRef) {
...
var Toast = React4.forwardRef(
  // blank line to reduce diff noise
  __name3(function Toast2(props, forwardedRef) {
...
var ToastImpl = React4.forwardRef(
  __name3(function ToastImpl2(props, forwardedRef) {
    const {
      __scopeToast,
      type = "foreground",
...
var ToastAnnounce = __name3((props) => {
...
var ToastTitle = React4.forwardRef(
  __name3(function ToastTitle2(props, forwardedRef) {
...
var ToastDescription = React4.forwardRef(
  // blank line to reduce diff noise
  __name3(function ToastDescription2(props, forwardedRef) {
...
var ToastAction = React4.forwardRef(
  __name3(function ToastAction2(props, forwardedRef) {
...
var ToastClose = React4.forwardRef(
  __name3(function ToastClose2(props, forwardedRef) {
...
var ToastAnnounceExclude = React4.forwardRef(__name3(function ToastAnnounceExclude2(props, forwardedRef) {
...
__name3(getAnnounceTextContent, "getAnnounceTextContent");
...
var isDeltaInDirection = __name3((delta, direction, threshold = 0) => {
...
__name3(useNextFrame, "useNextFrame");
function isHTMLElement(node) {
  return node.nodeType === node.ELEMENT_NODE;
}
__name3(isHTMLElement, "isHTMLElement");
